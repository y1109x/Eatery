...
<head>
    ...
    <script type="text/javascript">
        window.jQuery || document.write("<script src='${pageContext.request.contextPath}/back/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
    </script>
    ...
    <!--[if IE]>
    <script type="text/javascript">
        window.jQuery || document.write("<script src='${pageContext.request.contextPath}/back/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
    </script>
    <![endif]-->
