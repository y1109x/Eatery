...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/back/Widget/swfupload/swfupload.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/back/Widget/swfupload/swfupload.queue.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/back/Widget/swfupload/swfupload.speed.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/back/Widget/swfupload/handlers.js"></script>
        ...
        <div class="sort_Ads_list">
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <td><span class="ad_img"><a href="products/ad.jpg" data-rel="colorbox" data-title="广告图"><img src="${pageContext.request.contextPath}/back/products/ad.jpg"  width="100%" height="100%"/></a></span></td>
                    <td>1890x1080</td>
                ...
                <tr>
                    ...
                    <td><span class="ad_img"><a href="products/ad1.jpg" data-rel="colorbox" data-title="广告图"><img src="${pageContext.request.contextPath}/back/products/ad1.jpg"  width="100%" height="100%"/></a></span></td>
                    <td>1890x1080</td>
                    <td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
                    <td>2016-6-29 12:34</td>
                    <td class="td-status"><span class="label label-success radius">显示</span></td>
                ...
                <tr>
                    ...
                    <td>幻灯片</td>
                    <td><input name="" type="text"  style=" width:50px" placeholder="2"/></td>
                    <td><span class="ad_img"><a href="products/p_42.jpg" data-rel="colorbox" data-title="广告图"><img src="${pageContext.request.contextPath}/back/products/p_42.jpg"  width="100%" height="100%"/></a></span></td>
                    <td>1890x1080</td>
                    <td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
                    <td>2016-6-29 12:34</td>
                    <td class="td-status"><span class="label label-success radius">显示</span></td>
...
<div id="add_ads_style"  style="display:none">
 ...
 <div class="demo">
	           <div class="logobox"><div class="resizebox"><img src="${pageContext.request.contextPath}/back/images/image.png" width="100px" alt="" height="100px"/></div></div>
