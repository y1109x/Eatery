...
<head>
    ...
    <link href="${ctx}/back/assets/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="${ctx}/back/css/style.css"/>
    <link rel="stylesheet" href="${ctx}/back/assets/css/ace.min.css" />
    <link rel="stylesheet" href="${ctx}/back/assets/css/font-awesome.min.css" />
    <link href="${ctx}/back/Widget/icheck/icheck.css" rel="stylesheet" type="text/css" />
    <!--[if IE 7]>
    <link rel="stylesheet" href="${ctx}/back/assets/css/font-awesome-ie7.min.css" />
    <![endif]-->
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="${ctx}/back/assets/css/ace-ie.min.css" />
    <![endif]-->
    <script src="${ctx}/back/js/jquery-1.9.1.min.js"></script>
    <script src="${ctx}/back/assets/js/bootstrap.min.js"></script>
    <script src="${ctx}/back/assets/js/typeahead-bs2.min.js"></script>
    <script src="${ctx}/back/assets/layer/layer.js" type="text/javascript"></script>
    <script type="text/javascript" src="${ctx}/back/Widget/swfupload/swfupload.js"></script>
    <script type="text/javascript" src="${ctx}/back/Widget/swfupload/swfupload.queue.js"></script>
    <script type="text/javascript" src="${ctx}/back/Widget/swfupload/swfupload.speed.js"></script>
    <script type="text/javascript" src="${ctx}/back/Widget/swfupload/handlers.js"></script>
</head>
        ...
        <div class="left_add">
            ...
            <ul class="add_conent">
                ...
                <li class=" clearfix"><label class="label_name">品牌图片：</label>
                    <div class="demo l_f">
                        <div class="logobox"><div class="resizebox"><img src="${ctx}/back/images/image.png" width="100px" alt="" height="100px"/></div></div>
        ...
        <div class="right_add">
            ...
            <div class="p_select_list">
                <div class="left_produt produt_select_style" >
                    ...
                    <span class="seach_style"><label for="seach"></label><input name="" type="text" id="seach" class="seach"><i class="icon-search"></i></span>
                </div>
