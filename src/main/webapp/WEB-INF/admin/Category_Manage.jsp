...
<head>
    ...
    <link rel="stylesheet" href="/back/Widget/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
    ...
    <script type="text/javascript" src="/back/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script>
...
<div class=" clearfix">
    <div id="category">
        ...
        <!---->
        <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO  SRC="toProduct_category_add" class="page_right_style"></iframe>
    </div>
</div>
</body>
</html>
